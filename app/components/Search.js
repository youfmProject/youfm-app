    ...
    let homeSearch = (
      <div>
        ...
        <div className={classNames('banner__content')}>
            ...
            <input className={classNames('banner__search')} type="text" value = {searchKey} onChange= {onChange.bind(this)} placeholder="Type in a song or artist name" onKeyPress={onClick.bind(this)}/>
        </div>
      </div>
    );
      ...
      <div className={classNames("songs__search")} >
        <div className={classNames("songs__search__field")}>
          <span className={classNames("icon-search-icon songs__search__icon-1")}/>
            <input className={classNames("songs__search__input")} type="text" placeholder="Type in a song or artist name" value = {searchKey} onChange= {onChange.bind(this)} onKeyPress={onClick.bind(this)}/>
          <span className={classNames("icon-enter-icon songs__search__icon-2")} style={{right: '3em'}}>Press &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; enter to search</span>
        </div>
      </div>
    );
    return (
